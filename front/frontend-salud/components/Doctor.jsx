...
const Doctor = () => {
    return (
        <>
            <Link href="/turnos/reservarturnos/turnosdisponibles" className="bg-[#ebffff] shadow-[5px_5px_5px_rgba(0,0,0,0.2),10px_10px_10px_rgba(0,0,0,0.1)] bg-[100%_100%] h-[392px] relative w-[326px] rounded-[15%]">
